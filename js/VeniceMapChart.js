...
// get Venice destinations
var items = [];
var airtable_read_endpoint = "https://api.airtable.com/v0/app0i1h9wmkYVU5Cy/VeniceDestination%20Details?api_key=keysAky6ucMNj4qo4";
var data = [];
...
// get Venice other destinations
var items_O = [];
var airtable_read_endpoint_O = "https://api.airtable.com/v0/app91XcAbrCFOFooZ/VeniceDestinationDetails?api_key=keysAky6ucMNj4qo4";
var data_O = [];
...
// get Venice restaurants
var items_R=[]
var airtable_read_endpoint_R = "https://api.airtable.com/v0/appRTHgdOgIMg70zc/VeniceRestaurantsMerge?api_key=keysAky6ucMNj4qo4";
var data_R = [];
...
var items = [];
var i = 0;
var airtable_read_endpoint = "https://api.airtable.com/v0/appEYT4ObnjnGb7Tk/WeatherVenice?api_key=keysAky6ucMNj4qo4";
var dataSet = [];
$.getJSON(airtable_read_endpoint, function(result){
    $.each(result.records, function(key,value){
        items = [];
