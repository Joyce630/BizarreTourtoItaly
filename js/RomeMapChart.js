...
var map = L.map('Romemap')
          .addLayer(mapboxTiles)
          .setView([41.895, 12.475], 13.5);
// create custom icon
var arrow = L.icon({
...
// get Rome destinations
var items = [];
var airtable_read_endpoint = "https://api.airtable.com/v0/apphGQdSTNTXWSthS/RomeDestinationDetailsFinal?api_key=keysAky6ucMNj4qo4";
var data = [];
...
// get Rome other destinations
var items_O = [];
var airtable_read_endpoint_O = "https://api.airtable.com/v0/appiED6Xo0wbbwf2m/RomeOtherDestinationDetails?api_key=keysAky6ucMNj4qo4";
var data_O = [];
...
// get Rome restaurants
var items_R=[]
var airtable_read_endpoint_R = "https://api.airtable.com/v0/appjhtgnHkjZkCNt0/RomeRestaurants%20MergeFinal?api_key=keysAky6ucMNj4qo4";
var data_R = [];
...
var items = [];
var i = 0;
var airtable_read_endpoint = "https://api.airtable.com/v0/appM0P8lu4Kdk64HU/WeatherRome?api_key=keysAky6ucMNj4qo4";
var dataSet = [];
$.getJSON(airtable_read_endpoint, function(result){
    $.each(result.records, function(key,value){
        items = [];
